        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>              
              ...
              <td><?= $user->email; ?></td>
              <td>
              	<a href="users-control/make-admin.php?id=<?= $user->id; ?>" class="btn btn-success">Назначить администратором</a>
                <a href="user_profile.php?id=<?= $user->id; ?>" class="btn btn-info">Посмотреть</a>
                <a href="profile.php?id=<?= $user->id; ?>" class="btn btn-warning">Редактировать</a>
                <a href="users-control/delete_user.php?id=<?= $user->id; ?>" class="btn btn-danger" onclick="return confirm('Вы уверены?');">Удалить</a>
              </td>              
            </tr>
            <?php endforeach; ?>
          </tbody>
